        ...
        <Modal.Content>
          <Form inverted onSubmit={this.formSubmit}>
            ...
            <Form.Field>
              ...
              <input id="password" name="password" type="password" placeholder="Password" onChange={this.inputChange} value={this.state.password}></input>
            </Form.Field>
            <Form.Field>
              <label>Email</label>
              <input id="email" name="email" type="email" placeholder="Email" onChange={this.inputChange} value={this.state.email}></input>
            </Form.Field>
            <Form.Field>
              <label>Public Email</label>
              <input id="publicEmail" name="publicEmail" type="email" placeholder="Public Email" onChange={this.inputChange} value={this.state.publicEmail}></input>
            ...
            <Form.Field>
              <label>Zipcode</label>
              <input id="zipcode" name="zipcode" type="text" placeholder="Zipcode" onChange={this.inputChange} value={this.state.zipcode}></input>
            </Form.Field>
